...
class KB:
    def __init__(self):
        ...
        try:
            path = Path("knowledge_base/swiftcart_kb.json")
        ...
        self.index = VectorStoreIndex(
            ...
            embed_model=LiteLLMEmbedding(
                model_name="openai/BAAI/bge-multilingual-gemma2",
                api_base=api_base,
                api_key=api_key
            )
        )
...
llama_8b = create_llm_model("openai/meta-llama/Meta-Llama-3.1-8B-Instruct", "Llama 8B")
qwen = create_llm_model("openai/Qwen/Qwen3-235B-A22B", "Qwen")
